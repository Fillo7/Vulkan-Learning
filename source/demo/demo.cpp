...
int main(int argc, char* argv[])
{
    ...
    VulkanLearning::VulkanShaderModule vertexShader(device.getDevice(), "demo_vert.spv");
    VulkanLearning::VulkanShaderModule fragmentShader(device.getDevice(), "demo_frag.spv");
